...
get_header();
?>
<section id="inicio" class="py-18 px-20 bg-[#ded8cc]">
    <div class="flex gap-9.5 flex-col items-center md:min-h-100">
        <h1 class="text-[106px] leading-[1.038em] font-normal">
        We are a fine architecture firm in New York
        </h1>
       <div class="flex justify-between w-full">
            <div class="w-2/3 flex flex-col gap-8.25">
                ...
                <div class="flex items-center gap-4">
                    <a href="" class="flex gap-2 px-14 items-center h-14 bg-[#20341f] rounded-full text-white text-[20px] px-14 pt-5.5 pb-6 font-medium">
                        <i class="fa fa-whatsapp text-xl"></i>
                        <span>Fale conosco</span>  
                    </a>
                    <a href="" class="flex gap-2 items-center h-14 bg-[#ded8cc] border-2 border-[#20341f] rounded-full px-14 pt-5.5 pb-6 text-[20px] font-medium">
...
<section id="escritorio" class="py-18 px-18 bg-[#20341f]">
    <div class="flex flex-col gap-8">
        <div class="flex flex-col gap-9">
            <h1 class="text-[#ded8cc] text-[48px] font-medium">O Escritório </h1>
            <div class="flex flex-col gap-4">
            <p class="text-[#ded8cc] text-[18px] leading-[1.667em] text-justify">
        ...
        <div id="advogados" class="grid md:grid-cols-4 py-12 divide-x divide-white/10">
            <div>
               <div class="max-h-101 overflow-x-hidden px-4">
...
<section id="atuacao" class="bg-white px-20">
    <div>
...
<section id="noticias" class="px-20 py-18 flex flex-col gap-6">
    <div class="">
...
<section id="contato" class="px-20 py-18 flex items-center justify-between flex-col md:flex-row gap-6 bg-black">
<div>
